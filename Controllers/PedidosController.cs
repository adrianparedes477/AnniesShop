...
namespace AnniesShop.Controllers
{
    public class PedidosController : BaseController
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            .FirstOrDefaultAsync(d=>d.DireccionId == pedido.DirreccionIdSeleccionada)
            ?? new Direccion();
        ...
        public async Task<IActionResult> Create([Bind("PedidoId,UsuarioId,Fecha,Estado,DirreccionIdSeleccionada,Total")] Pedido pedido)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PedidoId,UsuarioId,Fecha,Estado,DirreccionIdSeleccionada,Total")] Pedido pedido)
        {
