...
namespace AnniesShop.Controllers
{
    public class DireccionesController : BaseController
    {
        ...
        public async Task<IActionResult> Create([Bind("DireccionId,Address,Cuidad,Estado,CodigoPostal,UsuarioId")] Direccion direccion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DireccionId,Address,Cuidad,Estado,CodigoPostal,UsuarioId")] Direccion direccion)
        {
